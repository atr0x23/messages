...
//Routes for users
$route['users'] = 'users/show'; //only for the admin | shows all users
$route['users/show'] = 'users/show'; //only for the admin | shows all users
...
$route['messages/mymessages/(:num)'] = 'messages/mymessages'; //shows only the messages of loged in user
